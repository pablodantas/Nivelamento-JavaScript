...
const r3 = list1.reduce(product,1);
...
function comprararPorTamanho(s1, s2){
    return s1.length - s2.length;
}
console.log("SORT-----------------");
const s1 = [...nomes].sort(comprararPorTamanho);
console.log(s1);
console.log(nomes);


const s2 = nomes.sort(comprararPorTamanho);
console.log(s2);
